...
model tGen1
  ...
  parameter Boolean refdisturb_1 annotation(
    Dialog(group = "AVR Disturbance"));
  OpenRES.Electrical.Machines.PSAT.Order4 gen(D = 0, M = 12.8, P_0 = P_0, Q_0 = Q_0, Sn = 2000, T1d0 = 5, T1q0 = 1.96, V_0 = V_0, V_b = V_b, Vn = 400, angle_0 = angle_0, ra = 0, x1d = 0.05, x1q = 0.057, xd = 0.2, xq = 0.2) annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {28, 14})));
  OpenRES.Electrical.Controls.PSAT.AVR.AVRTypeII AVR(Ae = 0.039, Be = 1.555, Ka = 0.1, Ke = 1, Kf = 0.0635, Ta = 20, Te = 0.314, Tf = 0.35, Tr = 0.001, v0 = V_0, vrmax = 5, vrmin = -5) annotation(
