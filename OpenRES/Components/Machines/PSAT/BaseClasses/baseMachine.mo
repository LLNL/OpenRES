within OpenRES.Electrical.Machines.PSAT.BaseClasses;
partial model baseMachine
  ...
  import Complex;
  parameter OpenRES.Types.ApparentPowerMega Sn "Power rating (MVA)"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRES.Types.VoltageKilo Vn "Voltage rating (kV)"
    annotation (Dialog(group="Machine parameters"));
