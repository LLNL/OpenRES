within OpenRES.Electrical.Solar.KTH;
model PFmodelmpptCorrected05MW
  ...
  OpenRES.Electrical.Solar.KTH.PFblocks.PVnew PVnew1 annotation (Placement(
        visible=true, transformation(
        origin={-95.0,-5.0},
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.PFblocks.DCBusBar DCBusBar1 annotation (
  ...
  Modelica.Blocks.Sources.Constant const3(k=v0) annotation (Placement(visible=
        ...
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.PFblocks.Controller controller1(
    xq=xq,
    xd=xd,
    v0=v0) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.PFblocks.Staticgenerator staticgenerator1(
    v0=v0,
    anglev0=anglev0,
    p0=p0,
    q0=q0) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Interfaces.PwPin pwPin1(vi(start=v0*sin(anglev0)), vr(start=v0*cos(
