...
model Controller
  ...
  Modelica.Blocks.Interfaces.RealOutput iq_ref annotation (Placement(
      ...
      iconTransformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.Auxiliary.PI PI2(
    K=Kdc,
    T=Tdc,
    xo=xd,
    Ymax=id_max,
    Ymin=id_min) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.Auxiliary.PI PI3(
    K=Kac,
    T=0.0005,
    Ymax=iq_max,
    Ymin=iq_min,
    xo=xq) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10.0,-10.0},{10.0,10.0}},
        rotation=0)));
  OpenRES.Electrical.Solar.KTH.Auxiliary.SimpleLagg simpleLagg1(xo=v0)
    annotation (Placement(visible=true, transformation(
