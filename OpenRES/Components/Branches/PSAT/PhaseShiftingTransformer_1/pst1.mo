within OpenRES.Electrical.Branches.PSAT.PhaseShiftingTransformer_1;
model pst1 "Tap ratio part of the PST"
  ...
  Real anglevm;
  OpenRES.Interfaces.PwPin p annotation (Placement(visible=true,
        transformation(extent={{-120,-8},{-100,12}})));
  OpenRES.Interfaces.PwPin n
