within OpenRES.Electrical.Branches.PSSE;
model TwoWindingTransformer
  ...
  OpenRES.Interfaces.PwPin p annotation (Placement(transformation(extent={{-80,
            -10},{-60,10}}), iconTransformation(extent={{-80,-10},{-60,10}})));
  OpenRES.Interfaces.PwPin n annotation (Placement(transformation(extent={{60,
