...
model Gen10
  ...
  OpenRES.Electrical.Controls.PSAT.AVR.AVRTypeII aVR3TypeII2(Ta = 0.02, Tf = 1, Ke = 1, Tr = 0.001, Ka = 20, Kf = 0.001, Te = 0.7, v0 = V_0, vrmin = 1.395, vrmax = 6.810) annotation(
    Placement(transformation(extent = {{-20, -21}, {20, 21}}, rotation = 0, origin = {-12, 13})));
  OpenRES.Electrical.Machines.PSAT.Order6 Syn4(D = 2, M = 2 * 5.06, P_0 = P_0, Q_0 = Q_0, Sn = 250, T1d0 = 10.2, T1q0 = 0.5, V_0 = V_0, V_b = V_b, Vn = 400, angle_0 = angle_0, fn = 60, ra = 0, x1d = 0.031, x1q = 0.008, x2d = 0.031, x2q = 0.0008, xd = 0.1, xq = 0.069) annotation(
...
equation
  connect(aVR3TypeII2.vf, Syn4.vf) annotation(
    Line(points = {{12, 13}, {20.5, 13}, {20.5, 9.5}, {34.6, 9.5}}, color = {0, 0, 127}));
  connect(Syn4.v, aVR3TypeII2.v) annotation(
    Line(points = {{73.7, 6.1}, {98, 6.1}, {98, -34}, {-36, -34}, {-36, 0.4}}, color = {0, 0, 127}));
  ...
  connect(Syn4.vf0, aVR3TypeII2.vf0) annotation(
    Line(points = {{41.4, 19.7}, {41.4, 38}, {12, 38}, {12, -24}, {-12, -24}, {-12, -12.2}}, color = {0, 0, 127}));
  connect(aVR3TypeII2.vref0, aVR3TypeII2.vref) annotation(
    Line(points = {{-12, 38.2}, {-12, 58}, {-12, 62}, {-56, 62}, {-56, 25.6}, {-36, 25.6}}, color = {0, 0, 127}));
  annotation(
