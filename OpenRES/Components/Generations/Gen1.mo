...
model Gen1
  ...
  OpenRES.Electrical.Controls.PSAT.AVR.AVRTypeII aVR3TypeII2(Ka = 20, Ke = 1, Kf = 1, Ta = 0.02, Te = 0.7, Tf = 1, Tr = 0.001, v0 = V_0, vrmax = 6.810, vrmin = 1.395) annotation(
    Placement(transformation(extent = {{-20, -21}, {20, 21}}, rotation = 0, origin = {-12, 13})));
  OpenRES.Electrical.Machines.PSAT.Order6 Syn4(D = 2, M = 2 * 5.06, P_0 = P_0, Q_0 = Q_0, Sn = 250, T1d0 = 7.0, T1q0 = 0.7, V_0 = V_0, V_b = V_b, Vn = 400, angle_0 = angle_0, fn = 60, ra = 0, x1d = 0.006, x1q = 0.008, xd = 0.02, xq = 0.019) annotation(
